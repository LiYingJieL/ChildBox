...
//		}
	...
	public String getPageHtml() {
		StringBuffer sb = new StringBuffer();
		if(totalResult>0){
			sb.append("<ul id=\"page\" class=\"pagination pagination-sm m-t-none m-b-none\">");
			sb.append("<input type=\"text\" value=\"" + currentPage + "\"");
			sb.append("</ul>");
		}
		return sb.toString();
	}
	...
	public String getPageData() {
		...
		Iterator<Map.Entry<Object, Object>> entries = pd.entrySet().iterator();  
		  
		while (entries.hasNext()) {  
		  
		    Map.Entry<Object, Object> entry = entries.next();  
		    sb.append("<input type=\"text\" name=\"" + entry.getKey() + "\" value=\"" + entry.getValue() + "\" />");
