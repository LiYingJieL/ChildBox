...
public class KdGoldAPI {
    ...
    //电商ID
    public final static String EBusinessID = "1313287";
    //电商加密私钥，快递鸟提供，注意保管，不要泄漏
    private final static String AppKey = "e9b003b9-c165-4c31-ad4d-0e0613ea68e0";
    //请求url
    private final static String ReqURL = "http://api.kdniao.cc/Ebusiness/EbusinessOrderHandle.aspx";


    public static void main(String[] args) throws Exception {
        String requestData = "{'Code': 'YD','Item': [" +
                "{'No': '3100951611849','Bk': ''}," +
                "]}";
        orderTracesSubByJson(requestData);
    }
     ...
     * @throws Exception
     */
    public static boolean orderTracesSubByJson(String requestData) throws Exception {
